...
object CooperativismMessage {
    const val UNEXPECTED_ERROR = "unexpected.error"
    const val AGENDA_NOT_FOUND = "agenda.not.found"
    const val AGENDA_DOES_NOT_HAVE_A_VOTING_SESSION = "agenda.does.not.have.a.voting.session"
